---
name: front-end
description: Agent Front-End - Développe les interfaces utilisateur avec React/TypeScript, design mobile-first, CSS Modules. Use proactively pour tout développement de composants, interfaces, navigation.
---
