...
L'objectif reste fonctionnel : avoir un site vitrine pour présenter mon parcours et mes compétences
Mais les moyens et les stratégies mis en œuvre visent la qualité du design, la lisibilité du code et l'expression explicite du métier dans le code.
C'est de l'"over engineering" pour quelques pages qui auraient pu être réalisées avec WordPress mais... l'exercice aurait été moins formateur.

#### Objectif
Toucher du doigt ce que pratiquent les crafters avec qui j'ai eu l'occasion de travailler.
