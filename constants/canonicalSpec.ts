...
const CANONICAL_SPEC_ORDER_BASE: CanonicalSpecEntry[] = [
  ...
  { nomCanonique: 'listeDesPages', typeHierarchique: '--c', containerParent: 'main-content-cont', containerLayout: 'listeDesPages.cont', dataLayout: 'draw with page properties' },
  { nomCanonique: 'listeDesPages.page', typeHierarchique: '--l1', containerParent: 'listeDesPages', containerLayout: null },
  { nomCanonique: 'hero', typeHierarchique: '--c', containerParent: 'main-content-cont', containerLayout: 'hero.cont', dataLayout: '2 columns' },
  ...
  { nomCanonique: 'listeDeProfils', typeHierarchique: '--c', containerParent: 'main-content-cont', containerLayout: 'listeDeProfils.cont', dataLayout: '4 columns x 1 row' },
  ...
  { nomCanonique: 'titre.texte', typeHierarchique: '--h2', containerParent: 'main-content-cont', containerLayout: null },
  { nomCanonique: 'video.urlYouTube', typeHierarchique: '--v', containerParent: 'main-content-cont', containerLayout: null },
  { nomCanonique: 'listeDeTemoignages', typeHierarchique: '--c', containerParent: 'main-content-cont', containerLayout: 'listeDeTemoignages.cont', dataLayout: '2 columns x N rows' },
  ...
  { nomCanonique: 'domaineDeCompetence', typeHierarchique: '--c', containerParent: 'main-content-cont', containerLayout: 'domaineDeCompetence.cont' },
  ...
  { nomCanonique: 'listeDesExperiencesEtApprentissages', typeHierarchique: '--c', containerParent: 'main-content-cont', containerLayout: 'listeDesExperiencesEtApprentissages.cont', dataLayout: 'accordeon, X rows' },
  ...
  { nomCanonique: 'texteLarge.texte', typeHierarchique: '--p', containerParent: 'main-content-cont', containerLayout: null },
  { nomCanonique: 'callToAction.action', typeHierarchique: '--b', containerParent: 'main-content-cont', containerLayout: null },
  { nomCanonique: 'groupeDeBoutons', typeHierarchique: '--c', containerParent: 'main-content-cont', containerLayout: 'groupeDeBoutons.cont', dataLayout: '1 column, centered' },
  ...
  { nomCanonique: 'listeDeDetournementsVideo', typeHierarchique: '--c', containerParent: 'main-content-cont', containerLayout: 'listeDeDetournementsVideo.cont', dataLayout: 'X rows' },
