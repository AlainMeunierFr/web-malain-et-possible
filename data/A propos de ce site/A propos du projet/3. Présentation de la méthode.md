# Bonnes pratiques de Développement logiciel : guide avec exemple pédagogique

## Plan de l'article
1. Introduction
2. Exprimer un besoin (User Story)
3. Conserver les spécifications (BDD)
4. Faire émerger le code (TDD)
5. TDD Strict (Red-Green-Refactor)
6. Bénéfices des tests
7. Contrôle qualité
8. Clean Code
9. Domain-Driven Design (DDD)
10. Architecture Hexagonale
11. Back-End Métier
12. Documentation des API
13. Front-End
14. Séparation contenu/présentation
15. CI/CD
16. Documentation technique détaillée
17. Sprint en cours et principes Kanban
18. Configuration IA et pair programming avec l’IA
19. Métriques : management visuel des délivrables

## 1. Introduction
**Pourquoi ces pratiques ?**
Développer un logiciel robuste, maintenable et évolutif nécessite une approche structurée. Ces pratiques visent à **clarifier les besoins**, **réduire les erreurs** et **faciliter la collaboration** entre tous les acteurs, qu'ils soient techniques ou non. L'exemple de la **connexion à un site web** sert ici de **fil conducteur pédagogique** pour illustrer chaque concept — ce n'est pas une fonctionnalité de ce site vitrine.
...
**Exemple (OpenAPI / YAML) :** voir la spécification exposée sur ce site via le module [API OpenAPI](/a-propos-du-site?view=openapi).
...
## 14. Séparation contenu/présentation
**Théorie :**
La **séparation entre contenu et présentation** consiste à distinguer la **structure sémantique** (DOM HTML) de son **style visuel** (CSS). Cela permet de modifier l'apparence sans altérer la logique ou le contenu, et facilite la collaboration entre développeurs et designers. Le contenu (DOM) décrit **ce que c'est**, tandis que le CSS décrit **comment ça s'affiche**. Sur ce site, la [Charte graphique](/a-propos-du-site/charte) formalise ces choix de présentation.
