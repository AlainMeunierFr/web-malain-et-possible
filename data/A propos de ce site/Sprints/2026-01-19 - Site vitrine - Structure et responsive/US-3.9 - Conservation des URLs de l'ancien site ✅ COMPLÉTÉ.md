...
## CA1 - Inventaire des URL à cloner
...
## CA4 - Détection automatique des pages
...
## CA5 - Détection automatique des liens internes
...
## CA6 - Structure JSON du plan du site
...
## CA7 - Test d'intégration de conformité
...
## CA8 - Validation des emplacements
...
## CA9 - Initialisation et régénération du plan
...
## CA10 - Composant ListeDesPages : Le composant `ListeDesPages.tsx` affiche les pages du site sous forme de boutons dans une grille
## CA11 - Chargement des données : Les données sont chargées depuis l'API `/api/site-map` qui retourne le plan du site au format JSON
## CA12 - Filtrage : Seules les pages avec `dessiner="Oui"` sont affichées
## CA13 - Tri : Les pages sont triées par `numero` (si présent), sinon par ordre alphabétique du titre
## CA14 - Grille responsive
...
## CA16 - Page dédiée : Route `/plan-du-site` qui affiche le composant `ListeDesPages`
## CA17 - Styles CSS : Fichier `ListeDesPages.module.css` avec styles cohérents avec le reste du site
## CA18 - Responsive : Le composant s'adapte aux différentes tailles d'écran
## CA19 - Note : L'implémentation utilise une grille de boutons plutôt qu'une représentation graphique avec rectangles et flèches, ce qui offre une meilleure accessibilité et une navigation plus directe