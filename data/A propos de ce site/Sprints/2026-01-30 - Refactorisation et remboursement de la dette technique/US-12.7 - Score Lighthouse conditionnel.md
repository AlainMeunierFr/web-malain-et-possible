...
- **CA1 - Stockage du timestamp de la dernière exécution** :
...
- **CA2 - Condition d'exécution (7 jours minimum)** :
...
**Notes techniques** :
- Utiliser l'API PageSpeed Insights de Google (gratuite, ~400 requêtes/jour)
- Endpoint : `https://www.googleapis.com/pagespeedonline/v5/runPagespeed`
- Pas de clé API requise pour un usage basique
- Pas de dépendance npm additionnelle (fetch natif)
