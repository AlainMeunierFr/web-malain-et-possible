# Language: fr
# Feature: Amélioration de l'affichage des "Critères d'acceptation" dans le wiki
...
Feature: Affichage structuré des critères d'acceptation dans le wiki
  ...
  Scenario: Détection de la section "Critères d'acceptation"
  ...
  Scenario: Fin de la section "Critères d'acceptation" à la prochaine US
  ...
  Scenario: Fin de la section "Critères d'acceptation" à un séparateur
    Étant donné qu'une section "Critères d'acceptation" est ouverte
    Quand une ligne contient uniquement "---"
    Alors la section "Critères d'acceptation" se termine avant cette ligne
    Et les lignes suivantes ne sont plus considérées comme faisant partie des critères d'acceptation

  Scenario: Fin de la section "Critères d'acceptation" à la fin de la sous-partie
  ...
  Scenario: Détection d'un thème de critère
    Étant donné qu'une section "Critères d'acceptation" est ouverte
  ...
  Scenario: Détection d'un critère normal
    Étant donné qu'une section "Critères d'acceptation" est ouverte
  ...
  Scenario: Hiérarchie thème-critères
  ...
  Scenario: Affichage d'un thème de critère
  ...
  Scenario: Affichage d'un critère normal
  ...
  Scenario: Structure hiérarchique visuelle
  ...
  Scenario: Règle dans la DOD pour l'IA
